...
if (array_key_exists('login', $_POST)) {
  session_start();
  $textfile = 'few912-4851hfksi13__f3--qj3ipswdfieo8f6d8a9wkfkvew90oqprifub6w2uneri3ir1d295jfwqmnbcxtilkjuy6544e4jdjk_37221_f32gio73d.txt';
	...
	<div id="page">
		...
		<div id="mainContent" class="center">
			...
			<div id="login_error">
				...
				<span class="javascript" align="center">Please do not share login information. Thank You.</span>
		</div>
	</div>
