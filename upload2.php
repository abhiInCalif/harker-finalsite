...
if (isset($_SESSION['authenticated'])) {
  header('Location: http://finals.cytopic.net/admins/upload.php');
  exit;
  }
?>
<?php
...
$upload2 = $teacher.$class.'_'.$name.'_'.$subject.'.'.'pdf';
if ($_POST['everything']) {
$file_content = $_FILES['uploadedfile']['tmp_name'];
$output_oldfile = file_get_contents($file_content);
$pdf=new FPDF();
$pdf->AddPage();
