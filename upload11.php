...
if (isset($_SESSION['authenticated'])) {
  header('Location: http://finalsprojcba321.cytopic.net/admins/upload.php');
  exit;
  }
?>
<?php
...
if (!(isset($_SESSION['loser']))) {
  header('Location: http://finalsprojcba321.cytopic.net/login.php');
  exit;
  }
?>
<?php
				...
				<p id="mainContent_" class="contentText">
					...
					<p class="attr_name" id="file_name_attr"><br >Please choose a file:</p>	
						...
						<p class="attr_name" id="your_name">Your Name <span class="eg">(FirstLast)</span>:</p>
							<input name="name2" type="text" id="name_input_attr">
							<?PHP
							if($name_vd == 1) {
